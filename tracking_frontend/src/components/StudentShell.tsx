            ...
            <div className="relative" ref={notifRef}>
              ...
              {showNotifications && (
                <>
                  ...
                  <div className="fixed left-1/2 -translate-x-1/2 top-14 w-80 max-h-[70vh] md:absolute md:left-auto md:translate-x-0 md:right-0 md:top-full md:mt-2 md:w-72 md:max-h-none bg-background border rounded-xl shadow-xl z-[60] overflow-hidden flex flex-col">
